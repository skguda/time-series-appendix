...
[![Deploy to Netlify](https://github.com/TheDataMine/time-series-appendix/actions/workflows/deploy.yml/badge.svg)](https://github.com/TheDataMine/time-series-appendix/actions/workflows/deploy.yml)
...
This repository contains the content for the Time Series appendix of [The Examples Book](https://the-examples-book.com).
